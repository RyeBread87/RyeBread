$(function () {
  ...
  RyeBread.GridManager = {};

  //************************* POSTS GRID
  RyeBread.GridManager.postsGrid = function (gridName, pagerName) {
    ...
    var addOptions = {
      ...
      onClose: onClose,
      afterSubmit: RyeBread.GridManager.afterSubmitHandler,
  ...
  //************************* CATEGORIES GRID
  RyeBread.GridManager.categoriesGrid = function (gridName, pagerName) {
  ...
  //************************* TAGS GRID
  RyeBread.GridManager.tagsGrid = function (gridName, pagerName) {
    var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
  ...
  RyeBread.GridManager.afterSubmitHandler = function (response, postdata) {
  ...
  $("#tabs").tabs({
    show: function (event, ui) {
      ...
      if (!ui.tab.isLoaded) {
          ...
          var gdMgr = RyeBread.GridManager,
