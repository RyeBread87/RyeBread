...
using RyeBread.Models;
#endregion

namespace RyeBread.Controllers
{
  /// <summary>
    ...
    public ViewResult Contact(Contact contact)
    {
      if (ModelState.IsValid)
      {
        using (var client = new SmtpClient())
        {
          ...
          var from = new MailAddress(adminEmail, "RyeBread Messenger");
          var to = new MailAddress(adminEmail, "RyeBread Admin");
